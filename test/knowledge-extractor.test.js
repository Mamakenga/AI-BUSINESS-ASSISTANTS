...
test("extractClaimTexts skips short structured bullet fragments without sentence endings", () => {
  const claims = extractClaimTexts(`
## Целевая аудитория
Родители детей 5-16 лет, желающие познакомить семью с искусственным интеллектом и научиться использовать AI-инструменты в быту и обучении. Уровень технической подготовки — начальный/средний.

## Цель курса
Дать родителям практические навыки безопасного и эффективного использования AI-технологий в повседневной жизни семьи: от помощи с домашними заданиями до организации досуга и развития цифровой грамотности детей.

### Модуль 1: «AI-помощник в учёбе»
- Как AI помогает с домашними заданиями (безопасно и осознанно)
`);
