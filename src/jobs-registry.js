...
const REGISTERED_JOBS = Object.freeze([
  {
    ...
    request_text:
      "Prepare the daily brief for the leader in Russian. Do not ask follow-up questions. Use the available context, compiled knowledge summaries, memory, and recent activity only. Prioritize compiled knowledge summaries when they are available, and use raw memory only to support or qualify them. If fresh data is limited, say that directly, do not fill gaps with invented business claims, and still produce the best concise brief you can. Keep it executive-friendly, but only state what is actually supported by the available context. Format it as a Telegram-ready update with exactly these sections: 1) Текущий статус, 2) Подтвержденные сигналы и изменения, 3) Срочные открытые вопросы, 4) Главный риск или блокировка, 5) Безопасный следующий шаг.",
  },
  {
    ...
    request_text:
      "Prepare the weekly digest for the leader in Russian. Do not ask follow-up questions. Use the available context, compiled knowledge summaries, memory, tasks, decisions, and recent activity only. Prioritize compiled knowledge summaries when they are available, and use raw memory only to support or qualify them. If confirmed information is limited, say that directly, do not fill gaps with invented business claims, and still produce the best concise digest you can. Keep it executive-friendly, but only state what is actually supported by the available context. Format it as a Telegram-ready update with exactly these sections: 1) Что изменилось за неделю, 2) Подтвержденные решения или сдвиги, 3) Нерешенные вопросы, 4) Риски или блокировки, 5) Главный фокус на следующую неделю.",
  },
  {
