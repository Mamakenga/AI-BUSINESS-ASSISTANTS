...
3. если сообщение написано в `00 Orchestrator`, роль по умолчанию — `orchestrator`;
4. если сообщение не удалось однозначно отнести ни к одной роли, система не гадает молча, а возвращает короткую подсказку founder-у.
